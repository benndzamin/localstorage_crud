...
$(document).ready(function () {
      ...
      columnDefs: [
        { data: "id", title: "Action" ,
            render: function (data) {
                ...
                <button type="button" data-set="${data}" name="edit" class="btn btn-outline-primary btn-sm edit" data-toggle="modal" data-target="#editModal">Edit</button>
                <button type="button" data-set="${data}" name="delete" class="btn btn-outline-danger btn-sm delete" >Delete</button>
                </div>`;
            },
            targets: 6,
        },
  ...
  function dropdownOptions() {
    for (var country in obj) {
      editCountry.options[editCountry.options.length] = new Option(
        country,
        country
      );
    }
    ...
    for (let c = 0; c < city.length; c++) {
      editCity.options[editCity.options.length] = new Option(city[c], city[c]);
    }
